...
function warnNoMessageFound(){
    ...
    <div class="msg-not-found fade-in">
        <img id="imgNoMsgFound" src="images/no-message-found-${imageColor}.svg" alt="Ningún mensaje fue encontrado.">
        <h3>Ningún mensaje fue encontrado</h2>
...
function validateTextareaRegex(){
    ...
    msgTextarea.value = removeDiacritics(msgTextarea.value).toLowerCase().replace(/[^a-z_ ]/g,'');
}
